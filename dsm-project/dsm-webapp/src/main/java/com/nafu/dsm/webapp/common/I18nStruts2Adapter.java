package com.nafu.dsm.webapp.common;
...
import org.displaytag.localization.*;
 ...
 * 
 * @author 
 *         <a:href="mailto:snowwolf@wabunoh-tech.com">mailto:snowwolf@wabunoh-tech
 *         .com</>
...
public class I18nStruts2Adapter implements LocaleResolver, I18nResourceProvider {
	...
	/**
	 * @see I18nResourceProvider#getResource(String, String, Tag,
	 *      javax.servlet.jsp.PageContext)
	 */
	public String getResource(String resourceKey, String defaultValue, Tag tag,
			PageContext pageContext) { // if resourceKey isn't defined either,
										// use defaultValue
